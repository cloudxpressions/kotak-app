...
<div class="card">
  <div class="card-header">
    <div>
      ...
      <p class="card-subtitle">Manage system users</p>
    </div>
  </div>
...
$(document).ready(function() {
    ...
    const table = $('#users-table').DataTable({
        ...
        columns: [
            ...
            { data: 'status_badge', name: 'email_verified_at', orderable: false, searchable: false },
        ...
        dom: 'Brt',
        buttons: [
            { extend: 'excel', className: 'd-none', exportOptions: { columns: [1, 2, 3, 4] } },
            { extend: 'pdf', className: 'd-none', exportOptions: { columns: [1, 2, 3, 4] } },
            { extend: 'csv', className: 'd-none', exportOptions: { columns: [1, 2, 3, 4] } },
            { extend: 'copy', className: 'd-none', exportOptions: { columns: [1, 2, 3, 4] } },
            { extend: 'print', className: 'd-none', exportOptions: { columns: [1, 2, 3, 4] } }
        ],
    ...
    $('#bulk-delete-btn').on('click', function() {
        ...
        Swal.fire({
            ...
            confirmButtonColor: '#d63939',
            cancelButtonColor: '#6c757d',
            confirmButtonText: `Yes, delete ${selectedIds.length} user(s)!`,
            cancelButtonText: 'Cancel'
        }).then((result) => {
            if (result.isConfirmed) {
                $.ajax({
