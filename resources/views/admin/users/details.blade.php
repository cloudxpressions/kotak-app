    ...
    <div class="row g-0">
      ...
      <div class="col-12 col-md-3 border-end">
        <div class="card-body">
          ...
          <nav class="list-group list-group-transparent" id="managedUserTabNav" role="tablist">
          ...
          <nav class="list-group list-group-transparent">
            <a href="#education-panel" class="list-group-item list-group-item-action d-flex align-items-center managed-user-panel-link" data-panel-target="#education-panel">Education</a>
            <a href="#skills-panel" class="list-group-item list-group-item-action d-flex align-items-center managed-user-panel-link" data-panel-target="#skills-panel">Skills</a>
          </nav>
        </div>
      </div>
      ...
      <div class="col-12 col-md-9 d-flex flex-column">
        <div id="managedUserFormContainer" class="d-flex flex-column flex-grow-1">
          <form action="{{ route('admin.users.update-details', $user->id) }}" method="POST" id="managedUserForm" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            
            <div class="card-body">
              <div class="tab-content" id="managedUserTabsContent">
            ...
            <div class="tab-pane fade show active" id="tab-personal" role="tabpanel" aria-labelledby="tab-personal-tab">
              ...
              <div class="row g-3 mt-2">
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control @error('mobile') is-invalid @enderror" name="mobile" value="{{ old('mobile', $user->mobile) }}">
                  @error('mobile') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-6">
                  <label class="form-label">WhatsApp</label>
                  <input type="text" class="form-control @error('whatsapp_number') is-invalid @enderror" name="whatsapp_number" value="{{ old('whatsapp_number', $user->whatsapp_number) }}">
              ...
              <div class="row g-3 mt-2">
                <div class="col-md-6">
                  ...
                  <input type="date" class="form-control @error('dob') is-invalid @enderror" name="dob" value="{{ old('dob', $user->dob ? $user->dob->format('Y-m-d') : '') }}">
              ...
              <div class="row g-3 mt-2">
                <div class="col-md-6">
                  <label class="form-check mt-2">
                    <input type="checkbox" class="form-check-input" name="is_differently_abled" id="is_differently_abled" value="1" {{ old('is_differently_abled', $user->is_differently_abled) ? 'checked' : '' }}>
                ...
                <div class="col-md-6 d-none" id="da_category_div">
                  ...
                  <select class="form-select select2" name="d_a_category_id">
                    ...
                    @foreach($daCategories as $dac)
                      <option value="{{ $dac->id }}" {{ old('d_a_category_id', $user->d_a_category_id) == $dac->id ? 'selected' : '' }}>{{ $dac->name }}</option>
                    @endforeach
                  </select>
                </div>
              </div>
              ...
              <div class="row g-3 mt-2">
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control @error('short_bio') is-invalid @enderror" name="short_bio" value="{{ old('short_bio', $user->short_bio) }}">
              ...
              <div class="row g-3 mt-2">
                <div class="col-md-12">
                  ...
                  <div class="mt-2">
                    ...
                    <div class="mt-2">
                      <img src="{{ asset('storage/' . $user->image) }}" alt="Current Profile Image" class="img-thumbnail" style="max-height: 200px;">
                    </div>
                  </div>
                  @endif
                </div>
            ...
            <div class="tab-pane fade" id="tab-address" role="tabpanel" aria-labelledby="tab-address-tab">
              ...
              <div class="row g-3 mt-2">
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control @error('locality') is-invalid @enderror" name="locality" value="{{ old('locality', $user->locality) }}">
                  @error('locality') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-6">
                  <label class="form-label">Pincode</label>
                  <input type="text" class="form-control @error('pincode') is-invalid @enderror" name="pincode" value="{{ old('pincode', $user->pincode) }}">
              ...
              <div class="row g-3 mt-2">
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control @error('aadhaar_number') is-invalid @enderror" name="aadhaar_number" value="{{ old('aadhaar_number', $user->aadhaar_number) }}">
            ...
            <div class="tab-pane fade" id="tab-family" role="tabpanel" aria-labelledby="tab-family-tab">
              ...
              <div class="row g-3">
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control @error('fathers_name') is-invalid @enderror" name="fathers_name" value="{{ old('fathers_name', $user->fathers_name) }}">
                  @error('fathers_name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-4">
                  <label class="form-label">Mother's Name</label>
                  <input type="text" class="form-control @error('mothers_name') is-invalid @enderror" name="mothers_name" value="{{ old('mothers_name', $user->mothers_name) }}">
                  @error('mothers_name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-4">
                  <label class="form-label">Parent Mobile</label>
                  <input type="text" class="form-control @error('parent_mobile_number') is-invalid @enderror" name="parent_mobile_number" value="{{ old('parent_mobile_number', $user->parent_mobile_number) }}">
                ...
                <div class="col-md-3">
                  ...
                  <select class="form-select select2" name="language_id">
                    ...
                    @foreach($languages as $lang)
                      <option value="{{ $lang->id }}" {{ old('language_id', $user->language_id) == $lang->id ? 'selected' : '' }}>{{ $lang->name }}</option>
                    @endforeach
                  </select>
                </div>
                <div class="col-md-3">
                  ...
                  <select class="form-select select2" name="timezone_id">
                    ...
                    @foreach($timeZones as $tz)
                      <option value="{{ $tz->id }}" {{ old('timezone_id', $user->timezone_id) == $tz->id ? 'selected' : '' }}>{{ $tz->name }}</option>
                    @endforeach
                  </select>
                </div>
                <div class="col-md-3">
                  ...
                  <select class="form-select select2" name="currency_id">
                    ...
                    @foreach($currencies as $curr)
                      <option value="{{ $curr->id }}" {{ old('currency_id', $user->currency_id) == $curr->id ? 'selected' : '' }}>{{ $curr->name }} ({{ $curr->symbol }})</option>
                    @endforeach
                  </select>
                </div>
                <div class="col-md-3">
                  ...
                  <select class="form-select select2" name="dateformat_id">
                    ...
                    @foreach($dateFormats as $df)
                      <option value="{{ $df->id }}" {{ old('dateformat_id', $user->dateformat_id) == $df->id ? 'selected' : '' }}>{{ $df->format }}</option>
                    @endforeach
                  </select>
                </div>
              </div>
                ...
                <div class="col-md-3">
                  ...
                  <select class="form-select select2" name="religion_id">
                    ...
                    @foreach($religions as $rel)
                      <option value="{{ $rel->id }}" {{ old('religion_id', $user->religion_id) == $rel->id ? 'selected' : '' }}>{{ $rel->name }}</option>
                    @endforeach
                  </select>
                </div>
                <div class="col-md-3">
                  ...
                  <select class="form-select select2" name="community_id">
                    ...
                    @foreach($communities as $comm)
                      <option value="{{ $comm->id }}" {{ old('community_id', $user->community_id) == $comm->id ? 'selected' : '' }}>{{ $comm->name }}</option>
                    @endforeach
                  </select>
                </div>
                <div class="col-md-3">
                  ...
                  <select class="form-select select2" name="user_classifications_id">
                    ...
                    @foreach($userClassifications as $uc)
                      <option value="{{ $uc->id }}" {{ old('user_classifications_id', $user->user_classifications_id) == $uc->id ? 'selected' : '' }}>{{ $uc->name }}</option>
                    @endforeach
                  </select>
                </div>
              </div>
              ...
              <div class="row g-3">
                <div class="col-md-4">
                  ...
                  <div class="input-group">
                    ...
                    <input type="url" class="form-control @error('facebook') is-invalid @enderror" name="facebook" value="{{ old('facebook', $user->facebook) }}" placeholder="https://facebook.com/username">
                  </div>
                ...
                <div class="col-md-4">
                  ...
                  <div class="input-group">
                    ...
                    <input type="url" class="form-control @error('twitter') is-invalid @enderror" name="twitter" value="{{ old('twitter', $user->twitter) }}" placeholder="https://twitter.com/username">
                  </div>
                ...
                <div class="col-md-4">
                  ...
                  <div class="input-group">
                    ...
                    <input type="url" class="form-control @error('linkedin') is-invalid @enderror" name="linkedin" value="{{ old('linkedin', $user->linkedin) }}" placeholder="https://linkedin.com/in/username">
                  </div>
            ...
            <div class="tab-pane fade" id="tab-payout" role="tabpanel" aria-labelledby="tab-payout-tab">
              ...
              <div class="row g-3">
                <div class="col-md-4">
                  ...
                  <input type="email" class="form-control @error('payout_email') is-invalid @enderror" name="payout_email" value="{{ old('payout_email', $user->payout_email) }}">
                  @error('payout_email') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-4">
                  <label class="form-label">Payout Icon (URL)</label>
                  <input type="text" class="form-control @error('payout_icon') is-invalid @enderror" name="payout_icon" value="{{ old('payout_icon', $user->payout_icon) }}">
                  @error('payout_icon') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-4">
                  <label class="form-label">Payout Amount</label>
                  <input type="number" step="0.01" class="form-control @error('payout') is-invalid @enderror" name="payout" value="{{ old('payout', $user->payout) }}">
        ...
        {{-- Education Section --}}
        <div id="education-panel" class="card-body border-top managed-user-panel d-none">
          <h2 class="mb-4">Education</h2>
          <div class="d-flex justify-content-between align-items-center mb-3">
            <p class="text-secondary mb-0">Maintain the education timeline for this user.</p>
                  ...
                  @foreach($user->education as $edu)
                    <tr>
                      ...
                      <td>
                        ...
                        <form action="{{ route('admin.users.delete-education', [$user->id, $edu->id]) }}" method="POST" onsubmit="return confirm('Are you sure?');" class="d-inline">
                          @csrf
                          @method('DELETE')
          ...
          @else
            <div class="empty">
              ...
              <p class="empty-subtitle text-muted">Add education records for this user.</p>
        ...
        {{-- Skills Section --}}
        <div id="skills-panel" class="card-body border-top managed-user-panel d-none">
          <h2 class="mb-4">Skills</h2>
          <div class="d-flex justify-content-between align-items-center mb-3">
            <p class="text-secondary mb-0">Highlight the strengths this user can help with.</p>
                  ...
                  @foreach($user->skills as $skill)
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <form action="{{ route('admin.users.delete-skill', [$user->id, $skill->id]) }}" method="POST" onsubmit="return confirm('Are you sure?');" class="d-inline">
                          @csrf
                          @method('DELETE')
          ...
          @else
            <div class="empty">
              ...
              <p class="empty-subtitle text-muted">Add skills for this user.</p>
              <div class="empty-action">
...
<div class="modal fade" id="addEducationModal" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="{{ route('admin.users.add-education', $user->id) }}" method="POST">
        @csrf
...
<div class="modal fade" id="addSkillModal" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="{{ route('admin.users.add-skill', $user->id) }}" method="POST">
        @csrf
        <div class="modal-header">
...
$(document).ready(function() {
  ...
  const formContainer = $('#managedUserFormContainer');
  const tabLinks = $('#managedUserTabNav [data-bs-toggle="tab"]');
  const panelLinks = $('.managed-user-panel-link');
  const additionalPanels = $('.managed-user-panel');
  ...
  panelLinks.on('click', function(e) {
    ...
    $('#managedUserTabsContent .tab-pane').removeClass('show active');
  ...
  const firstInvalid = $('#managedUserForm .is-invalid').first();
  ...
  $(document).on('click', '.edit-education-btn', function() {
    ...
    $('#editEducationForm').attr('action', '{{ route("admin.users.update-education", [$user->id, ":id"]) }}'.replace(':id', id));
  ...
  $(document).on('click', '.edit-skill-btn', function() {
    ...
    $('#editSkillForm').attr('action', '{{ route("admin.users.update-skill", [$user->id, ":id"]) }}'.replace(':id', id));
