...
<div class="card">
  <div class="card-header">
    <div>
      <h3 class="card-title">Blog Tag Management</h3>
      <p class="card-subtitle">Manage blog tags and their translations</p>
    </div>
  </div>
  ...
  <div class="table-responsive">
    <table class="table card-table table-vcenter text-nowrap datatable" id="tags-table">
      <thead>
        <tr>
...
$(document).ready(function() {
    ...
    const table = $('#tags-table').DataTable({
        processing: true,
        serverSide: true,
    ...
    $('#bulk-delete-btn').on('click', function() {
        ...
        Swal.fire({
            ...
            confirmButtonColor: '#d63939',
            cancelButtonColor: '#6c757d',
            confirmButtonText: `Yes, delete ${selectedIds.length} tag(s)!`,
            cancelButtonText: 'Cancel'
        }).then((result) => {
            if (result.isConfirmed) {
                $.ajax({
