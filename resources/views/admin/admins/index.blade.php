...
<div class="card">
  <div class="card-header">
    <div>
      ...
      <p class="card-subtitle">Manage system administrators</p>
    </div>
  </div>
  ...
  <div class="table-responsive">
    <table class="table card-table table-vcenter text-nowrap datatable" id="admins-table">
      <thead>
        <tr>
...
$(document).ready(function() {
    ...
    const table = $('#admins-table').DataTable({
        ...
        columns: [
            ...
            { data: 'roles_badge', name: 'roles', orderable: false, searchable: false },
    ...
    $('#bulk-delete-btn').on('click', function() {
        ...
        Swal.fire({
            title: 'Delete Multiple Admins?',
            text: `You are about to delete ${selectedIds.length} admin(s). This action cannot be undone!`,
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#d63939',
            cancelButtonColor: '#6c757d',
            confirmButtonText: `Yes, delete ${selectedIds.length} admin(s)!`,
            cancelButtonText: 'Cancel'
        }).then((result) => {
            if (result.isConfirmed) {
                $.ajax({
