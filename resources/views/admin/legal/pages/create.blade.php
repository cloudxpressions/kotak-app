...
<div class="card">
  <div class="card-header">
    <div>
      <h3 class="card-title">Create Legal Page</h3>
      <p class="card-subtitle">Add a new legal page to your website</p>
    </div>
  </div>
  <div class="card-body">
    <form action="{{ route('admin.legal.pages.store') }}" method="POST">
      ...
      <div class="text-end">
        ...
        <button type="submit" class="btn btn-primary">Create Legal Page</button>
      </div>
    </form>
  </div>
</div>
