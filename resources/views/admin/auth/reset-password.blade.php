    ...
    <div class="container container-tight py-4">
      ...
      <form class="card card-md" action="{{ route('admin.password.store') }}" method="POST" autocomplete="off">
        ...
        <div class="card-body">
          ...
          <p class="text-secondary mb-4">Enter your email address and new password.</p>
          ...
          <div class="mb-3">
            ...
            <div class="input-group input-group-flat">
              ...
              <span class="input-group-text">
                <a href="#" class="link-secondary" title="Show password" data-password-toggle>
          ...
          <div class="form-footer">
            <button type="submit" class="btn btn-primary w-100">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-key">
