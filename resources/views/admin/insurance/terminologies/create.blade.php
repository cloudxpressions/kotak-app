...
@section('page-title', 'Create Terminology')
...
<div class="page-body">
  <div class="container-xl">
    <div class="row">
      <div class="col-12">
        <form action="{{ route('admin.insurance.terminologies.store') }}" method="POST">
          @csrf
          ...
          <div class="card-footer text-end">
            <div class="d-flex">
              ...
              <button type="submit" class="btn btn-primary ms-auto">Create Terminology</button>
            </div>
          </div>
        </form>
      </div>
