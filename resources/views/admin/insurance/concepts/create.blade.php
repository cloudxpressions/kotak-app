...
@section('page-title', 'Create Concept')
...
<div class="page-body">
  <div class="container-xl">
    <div class="row">
      <div class="col-12">
        <form action="{{ route('admin.insurance.concepts.store') }}" method="POST">
          @csrf
          ...
          <div class="card-footer text-end">
            <div class="d-flex">
              ...
              <button type="submit" class="btn btn-primary ms-auto">Create Concept</button>
            </div>
          </div>
        </form>
      </div>
