        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('order_no') is-invalid @enderror" name="order_no" value="{{ old('order_no', $category->order_no ?? '') }}">
                    @error('order_no')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
    ...
    <div class="card-body">
        <div id="translations-container">
            @if(old('translations'))
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error("translations.$index.name") is-invalid @enderror" name="translations[{{ $index }}][name]" value="{{ $translation['name'] }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Slug</label>
                                <input type="text" class="form-control @error("translations.$index.slug") is-invalid @enderror" name="translations[{{ $index }}][slug]" value="{{ $translation['slug'] }}">
                ...
                @endforeach
            @elseif(isset($category) && $category->translations->count() > 0)
...
document.addEventListener('DOMContentLoaded', function() {
    let translationIndex = {{ old('translations') ? count(old('translations')) : (isset($category) ? $category->translations->count() : 0) }};
            ...
            <div class="translation-row mb-3 p-3 border rounded">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label">Slug</label>
                            <input type="text" class="form-control" name="translations[${translationIndex}][slug]" required>
                        </div>
                    </div>
                </div>
