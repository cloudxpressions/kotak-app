...
{
    use HasFactory, Notifiable, HasRoles, LogsActivity, CanResetPassword;
    ...
    public function education() { return $this->hasMany(\App\Models\AdminEducation::class); }
    public function skills() { return $this->hasMany(\App\Models\AdminSkill::class); }
}
